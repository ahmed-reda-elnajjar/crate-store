...
export const SEED_PRODUCTS: Product[] = ([
  { id: "boxy-heavy-tee", name: "Boxy Heavy Tee", price: 48, category: "tops", colourways: ["Bone", "Black", "Ash", "Olive"], sizes: APPAREL, stock: { S: 30, M: 40, L: 30, XL: 14, XXL: 6 }, tag: "New", drop: "07", fabric: "240gsm organic cotton jersey", fit: "Boxy, cropped body", shape: "tee", model: "/models/garments/boxy-heavy-tee.glb", modelSize: "M", live: true, added: 10 },
  { id: "double-knee-carpenter", name: "Double-Knee Carpenter", price: 128, category: "bottoms", colourways: ["Black", "Tan", "Grey"], sizes: ["28", "30", "32", "34", "36"], stock: { "28": 8, "30": 16, "32": 20, "34": 14, "36": 6 }, drop: "07", fabric: "12oz cotton canvas", fit: "Relaxed, straight leg", shape: "pants", model: "/models/garments/double-knee-carpenter.glb", modelSize: "32", live: true, added: 9 },
